...
photo_path = r'C:\Users\pc\.gemini\antigravity\brain\ab98e414-96f1-47f0-bd3d-25b94e55a072\.user_uploaded\media_1789721656657.jpg'
devotee_name = 'H.G. KIRTI NARAYAN PRABHU'
devotee_id = 'kirti_narayan'

src = Image.open(photo_path).convert('RGB')
w, h = src.size

crop_size = int(min(w, h) * 0.38)
cx = int(w * 0.50)
cy = int(h * 0.68)
...
print('SUCCESS_KIRTI_NARAYAN_PUSHED')
