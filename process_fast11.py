...
devotees = [
    {
        ...
        'line2': 'PRABHU',
        'id': 'radha_madhav',
        'img_path': r'C:\Users\pc\.gemini\antigravity\brain\ab98e414-96f1-47f0-bd3d-25b94e55a072\.user_uploaded\media_1789724694713.jpg',
        'crop_cx': 0.66,
        'crop_cy': 0.35,
        'crop_scale': 0.28
    },
    {
        ...
        'line1': 'H.G. PAWAN ATMAJ',
        'line2': 'PRABHU',
        'id': 'pawan_atmaj',
        'img_path': r'C:\Users\pc\.gemini\antigravity\brain\ab98e414-96f1-47f0-bd3d-25b94e55a072\.user_uploaded\media_1789724723432.jpg',
        'crop_cx': 0.51,
        'crop_cy': 0.44,
        'crop_scale': 0.35
    }
...
subprocess.run(['git', 'commit', '-m', 'Add cards for HG Radha Madhav Prabhu and HG Pawan Atmaj Prabhu'], cwd=base_dir, check=True)
subprocess.run(['git', 'push', 'origin', 'main'], cwd=base_dir, check=True)
print('SUCCESS_BOTH_PUSHED_SUPER_FAST')
